                                    ...
                                    guint        *corners)
{
  ...
  if (sum > 0)
    min = MIN (node->alloc_width/sum, min);
  ...
  if (sum > 0)
    min = MIN (node->alloc_height/sum, min);
  ...
  corners[ST_CORNER_TOPLEFT]     = node->border_radius[ST_CORNER_TOPLEFT]     * min;
  corners[ST_CORNER_TOPRIGHT]    = node->border_radius[ST_CORNER_TOPRIGHT]    * min;
  corners[ST_CORNER_BOTTOMLEFT]  = node->border_radius[ST_CORNER_BOTTOMLEFT]  * min;
  corners[ST_CORNER_BOTTOMRIGHT] = node->border_radius[ST_CORNER_BOTTOMRIGHT] * min;
}
