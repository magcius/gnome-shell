 ...
 * Written by Emmanuele Bassi, originally licensed under LGPL 2.1.
...
st_layout_container_paint (ClutterActor  *actor)
{
  ...
  CLUTTER_ACTOR_CLASS (st_layout_container_parent_class)->paint (actor);
                          ...
                          const ClutterColor  *color)
{
  ...
  CLUTTER_ACTOR_CLASS (st_layout_container_parent_class)->pick (actor, color);
...
st_layout_container_class_init (StLayoutContainerClass *klass)
{
  ...
  actor_class->paint = st_layout_container_paint;
  actor_class->pick = st_layout_container_pick;
  actor_class->get_paint_volume = st_container_real_get_paint_volume;
